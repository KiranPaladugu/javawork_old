...
%JAVAVM% -Dlog4j.configuration=file:../CONF/log4j.xml -classpath %TMF_XP% com.marconi.fusion.base.asn1.msg.FileMsgBerReader com.marconi.fusion.I36.I36MessageFactory %* 
