...
%JAVAVM% -Dlog4j.configuration=file:../CONF/log4j.xml -classpath %TMF_XP% com.marconi.fusion.tmf.usermgt.SetupUser ../CONF/TMFFramework.properties
...
:RESNOTOK
echo SetupUser application NOT executed!
