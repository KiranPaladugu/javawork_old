...
public class FrameAndView {
    ...
    private class AlarmDetails {
        ...
        public String toString() {
            String msg = "";
            msg = alarm + "\t" + context + "\t" + pc + "\t" + pcId + "\t" + alarmDetail + "\t" + signal + "\t" + alarmID + "\t"
                    + cardType + "\t" + tpType + "\t" + "\t" + "\t" + "\t" + "\t"
                    //					+ syntax +"\t"
                    + type + "\t" + neName + "\t" + neType + "\t" + connType + "\t" + eventType + "\t";
            return msg;
        }
    }
    ...
    private void openFileToTextViewer(File file) {
        if (file.exists()) {
            if (file.length() > (50 * 1048576)) {
                JOptionPane.showMessageDialog(frame, "File is greater than 50MB !!", "ERROR!!", JOptionPane.ERROR_MESSAGE);
            } else {
                currentFile = file;
