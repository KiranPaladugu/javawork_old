...
public class BufferedImageMouseDrag extends JFrame {
	private static final long serialVersionUID = 1258744459142761413L;
...
class DisplayCanvas extends JPanel {
	private static final long serialVersionUID = -3922770391101427022L;
	...
	DisplayCanvas() {
		...
		Image image = getToolkit().getImage(ResourceFinder.getResource("bb.gif"));
